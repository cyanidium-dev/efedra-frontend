      ...
      <Container>
        ...
        <div className="flex flex-col md:flex-row-reverse gap-3.5 lg:gap-[30px]">
          <div className="md:w-[calc(50%+70px)] lg:w-[calc(50%+80px)] xl:w-[calc(50%-15px)]">
            ...
            <p className="max-w-[438px] mb-7 lg:mb-[43px]">
          ...
          <div className="relative w-full md:w-[calc(50%-84.5px)] lg:w-[calc(50%-110px)] xl:w-[calc(50%-15px)] h-[195px] xs:h-[280px] sm:h-[320px] md:h-[287px] lg:h-[330px] xl:h-[373px] overflow-hidden rounded-[20px]">
            <Image
