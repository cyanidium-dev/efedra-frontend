      ...
      <Container>
        ...
        <div className="flex flex-col gap-6 pt-1 md:hidden">
          ...
          <motion.div
            ...
            className="relative w-full md:w-[calc(50%)] h-[319px]  sm:h-[390px] overflow-hidden rounded-tl-[300px] rounded-tr-[300px] rounded-br-[20px] rounded-bl-[300px]"
          >
            <Image
        ...
        <div className="hidden md:flex items-center pt-[31.17px]">
          <motion.ul
            ...
            exit="exit"
            viewport={{ once: true, amount: 0.4 }}
            className="flex flex-col gap-7 lg:gap-0 md:w-[calc(50%-10px)] lg:w-[calc(50%)]"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.3 }}
            variants={fadeInAnimation({ scale: 0.95, delay: 0.3 })}
            className="relative w-full md:w-[calc(50%+10px)] lg:w-[calc(50%+10px)] xl:w-[calc(50%)]  md:h-[600px] lg:h-[625px] xl:h-[625px] overflow-hidden rounded-tl-[300px] rounded-tr-[300px] rounded-br-[20px] rounded-bl-[300px]"
          >
            <Image
              src="/images/aboutPage/advantages/destistry.webp"
              alt="building"
